...
fort_lobby_handler:
  ...
  events:
    ...
    - define motd "                  <&b><&k><&l>k<&r> <&f><&l>» <element[<&l>NIMBUS].color_gradient[from=#ffc800;to=#ffea9c]> <&f><&l>« <&b><&k><&l>k<&r><&r><&nl>           <&b><&l>NIMNITE <&7>test run in <&f><time[2024/01/20_23:00:00].duration_since[<util.time_now>].formatted><&7>!"
