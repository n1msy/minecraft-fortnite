fort_consumable_handler:
  ...
  events:
    ...
    - choose <[name]>:
      ...
      - case bush:
        - spawn <entity[item_display].with[item=<item[leather_helmet].with[custom_model_data=10;color=black]>;scale=1.2,1.2,1.2;translation=0,-0.75,0]> <player.location.with_pose[0,0].above> save:bush
